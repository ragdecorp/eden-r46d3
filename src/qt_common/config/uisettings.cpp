...
const std::array<Shortcut, 34> default_hotkeys{{
    ...
    {QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Toggle Cheat Overlay")).toStdString(),      QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Main Window")).toStdString(), {std::string("Ctrl+Shift+C"), std::string("ZL+ZR+Plus"), Qt::ApplicationShortcut, false}},
